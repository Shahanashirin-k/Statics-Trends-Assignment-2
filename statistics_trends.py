...
def bargraph():
   ...
   CH4_df.plot(kind='bar', figsize=(10, 5), width=0.5,color=C, edgecolor='black', fontsize=10)
   ...
   plt.title("Methane emissions in KMT of CO2 eq")
...
if __name__ == '__main__':
    # Calling the bargraph function to visualise the barplot
    bargraph()
